import dblLinear from './twice-linear.solution.mjs';
...
test(fn, [20], 57, assertEqual)
test(fn, [30], 91, assertEqual)
test(fn, [50], 175, assertEqual)
test(fn, [100], 447, assertEqual);  
